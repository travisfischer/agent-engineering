...
1. `${CLAUDE_PLUGIN_ROOT}/workflows/review/workflow.md`
2. `${CLAUDE_PLUGIN_ROOT}/workflows/review/reviewers.md`
2. `${CLAUDE_PLUGIN_ROOT}/workflows/review/output-template.md`
3. `${CLAUDE_PLUGIN_ROOT}/workflows/review/checklist.md`
